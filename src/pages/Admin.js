...
import { Table,TableBody,TableCell,Container,TableHead,TableRow,Button,IconButton,} from '@mui/material';
            ...
            <Container maxWidth="md">
                ...
                <Table 
                    ...
                    <TableRow>
                        ...
                        <TableCell align="center">신고내용</TableCell>
                    ...
                    {reportList ? data.allReports.map((a, index) => (
                        <TableRow key={index}>
                            ...
                            <TableCell align="center">{data.allReports[index].content}</TableCell>
